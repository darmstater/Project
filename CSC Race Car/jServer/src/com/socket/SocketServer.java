	...
	if (msg.content.equals(".bye")){
            ...
            if(msg.type.equals("login")){
                ...
                if(msg.recipient.equals("All")){
                    ...
                    if(msg.content.equals("Finish")){
                        Announce("message", "SERVER", "GAMEOVER, " + msg.sender +" menang!");
                        ui.jButton3.setEnabled(true);
                    }
                 
            
                    if(msg.content.equals("Nabrak pengahalang oi")){
                        Announce("message", "SERVER", msg.sender +" Nabrak pengahalang oi");
                    }
                    
                    if(msg.content.equals("Nabrak atas!")){
                        Announce("message", "SERVER", msg.sender +" Nabrak atas!");
                    }
                     
                    if(msg.content.equals("Nabrak bawah!")){
                        Announce("message", "SERVER", msg.sender +" Nabrak bawah!");
                    }
